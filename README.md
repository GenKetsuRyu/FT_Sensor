...
Download the calibration software [**Visual Demo Software**] （https://robotiq.com/support/archive/ "**Visual Demo Software**") (The software must be installed on the **windows** environment)
